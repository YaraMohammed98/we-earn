            ...
            <div className="container" >
                <div className="row text-uppercase fw-bold" style={{fontSize:"15px"}}>
                    <div className="col-md-6">
                        <div className="w-100">
                            <h4 style={{fontSize:"15px"}} className="bg-darkgrey text-white text-center p-2 ">
                            PERSONAL STATISTICS
                            </h4>
                            ...
                            <div className=" d-flex flex-column w-100 text-center ">
                                    ...
                                    <p className="main-color"style={{fontSize:"12px"}}>0x31484A76BB061BBAb1202D91f5BefC2F1878bA44</p>
                            </div>
                            <div className=" d-flex flex-column w-100 text-center">
                    ...
                    <div className="col-md-6" >
                        <div className="w-100">
                            ...
                            <div className=" d-flex flex-column w-100 text-center">
                                    <p className="main-color" style={{fontSize:"12px"}}>0x918919422635291f02ee56108618753c4fa0901f</p>
                                    ...
                                    <p className="main-color" style={{fontSize:"12px"}}>0xae2d4617c862309a3d75a0ffb358c7a5009c673f</p>
                                    {isShow &&
                                        <span className="mb-2">(0.01 BNB)</span>
                                    }
                            </div>
                            <h4 style={{fontSize:"12px"}} className="bg-darkgrey text-white text-center p-2 ">
                            next top referrers
                            </h4>
                            ...
                            <div className=" d-flex flex-column w-100 text-center">
                                    ...
                                    <p className="main-color" style={{fontSize:"12px"}}>0xbe2fd46639eae548552aa79b1245d65718cb89d9</p>
                                    <p style={{fontSize:"15px"}}>tommybones has 17  BNB referral investments</p>
                                    <p className="main-color" style={{fontSize:"12px"}}>0x1aceeeca69b4618c7d09a32f0e1ef6da3565c4c1</p>
