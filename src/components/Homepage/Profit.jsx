     ...
     <div className="profit-card col-lg-8 shadow bg-white">
            ...
            <div className="card-body px-5">
                <div className="container ">
                    ...
                    <div className="row mb-5 pro ">
                        <div className="col-lg-6 d-flex mb-4 pro-con justify-content-center  align-items-center">
